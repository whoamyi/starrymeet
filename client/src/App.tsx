...
import { LandingPremium, Auth, Dashboard, Profile, Settings, Messages, Bookings, Favorites, Browse, CelebrityProfile, About, FAQ, Contact, HowItWorksPage, ForCelebrities, Team, Jobs, Terms, Privacy } from '@/pages';
