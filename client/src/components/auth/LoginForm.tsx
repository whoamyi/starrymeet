  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-gray-400">Sign in to continue to StarryMeet</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="px-3 bg-gradient-to-b from-gray-900/90 to-black/90 text-gray-500">or continue with</span>
          </div>
        </div>
