...
export const SignupForm = ({ onSwitchToLogin }: SignupFormProps) => {
  ...
  useEffect(() => {
    ...
    // Determine text and normalize strength to 0-3
    if (strength <= 2) {
      text = 'Weak';
      strength = 1;
    } else if (strength <= 4) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!formData.agreeToTerms) {
      toastConfig.error('Please agree to the Terms of Service and Privacy Policy');
      return;
    }
  ...
  return (
    <div className="w-full max-w-md">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400">Start connecting with your icons today</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <div className="flex items-start">
          ...
          <label htmlFor="agreeToTerms" className="ml-2 text-sm text-gray-300">
            I agree to the{' '}
            <a href="/terms" target="_blank" className="text-[#D4A574] hover:text-[#C49563] transition">
              Terms of Service
            </a>{' '}
            and{' '}
            <a href="/privacy" target="_blank" className="text-[#D4A574] hover:text-[#C49563] transition">
              Privacy Policy
            </a>
          </label>
        </div>
